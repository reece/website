...
the [Salk Institute](https://salk.edu/). I then completed a dual PhD/MS in
molecular biophysics and computer science at Washington University in St. Louis,
followed by post-doctoral work at the [IBM Watson Research
Center](https://research.ibm.com/labs/yorktown-heights). This education was
enabled by public funding through the [National Institutes of
...
protein structure prediction to identify novel targets in the (then) draft human
genome. This work led to the development of Unison, the protein annotation
system that was used by research, development, and legal teams for over a decade
...
clinical operations team that received our first ~50 clinical samples, hired our
...
I have joined and helped build open and academic efforts to promote standards.
I am the first author of the most recent update to the [HGVS
Nomenclature](https://doi.org/10.1186/s13073-024-01421-5), an
internationally-recognized standard for the description of DNA, RNA, and protein
...
skills, and experience to improve political representation in the United States.
In 2017, I began volunteering with [States Win](https://stateswin.org/) (then
known as Sister District), including extensive canvassing in Arizona,
co-organizing the San Francisco chapter's canvassing effort in 2019, and leading
a Virginia canvassing delegation that led to the VA trifecta. In 2020, I was a
core member of the small, passionate, and all-volunteer team that built
[landslide2020.org](http://landslide2020.org), a relational organizing platform
to promote accountability among friends. In 2026, I helped modernize
[Indivisible SF's website](https://indivisiblesf.org). I also built [No Kings
Countdown](http://nokingscountdown.org/) to motivate people leading up to No
...
![Reece sailing on Fogdog](/images/skipper.webp)
![Thirst'n'Howl](/images/tnh.webp)
![The dogs, Chewie and Wilbur](/images/dogs.webp)
